        ...
        <div class="container">
         <div class="">
            ...
            <div class="new-law-dec shadow-sm">
              <h3 class="blue-title">Corporate-Law</h3>
                <!-- <h3 class="text-spacing-25 font-weight-normal title-opacity-9">Corporate-Law</h3> -->
                <p class="blue-para">Corporate Law deals with the formation and operations of corporations and is related to commercial and contract law. A corporation is a legal entity created under the laws of the state it’s incorporated within. State laws, which vary from state to state, regulate the creation, organization and dissolution of their corporations. A corporation creates a legal or “artificial person” or entity that has standing to sue and be sued, enter into contracts, and perform other duties necessary to maintain a business, separate from its stockholders.</p>
                <p class="blue-para">Corporations are taxable entities, which shields the individual owners or shareholders from personal liability for the liabilities and debts of the corporation, with some limited exceptions – such as unpaid taxes.</p>
                <p class="blue-para">Corporations are taxable entities, which shields the individual owners or shareholders from personal liability for the liabilities and debts of the corporation, with some limited exceptions – such as unpaid taxes.</p>
                <p class="blue-para">Corporate law professionals are trained in the legal formation of corporations. These attorneys also construct joint ventures, licensing arrangements, mergers, acquisitions, and the countless other transactions entered into by corporations. Other areas of practice include business formations, securities law, venture capital financing, business agreements, internal forms, and business tax consultations.</p>
      ...
      <!--=====================================Family-Law Section End =====================================-->
        ...
        <section class="section section-sm section-top-0 section-fluid section-relative bg-gray-4">
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-md-12">
                <div id="news-slider" class="owl-carousel customCarousel" data-items="1" data-sm-items="1" data-md-items="3"
